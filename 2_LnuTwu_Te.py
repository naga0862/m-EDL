...
import pandas
summary_folder = r'Z:/ENN_acc/2_LnuTwu_ltr/'
# import requests
# import urllib3
...
if __name__ == '__main__':
    ...
    for i_trial in range (0,100):#take mean of result
        print('2_LnuTwu_ltr {}th trial!!!!!!!!!!!!!'.format(i_trial+1))
        ...
        #combine data: LnuTwu = Learning: mnist, Test: mnist&fashion
        #yu = 1 when U, 11D
        ...
        accs_k_forMixt_df.to_csv(summary_folder+r'{0}_ltr_accs_k_{1}.csv'.format('2_LnuTwu',i_trial))
        accs_U_forMixt_df.to_csv(summary_folder+r'{0}_ltr_accs_U_{1}.csv'.format('2_LnuTwu',i_trial))
        ...
        recalls_k_forMixt_df.to_csv(summary_folder+r'{0}_ltr_recalls_k_{1}.csv'.format('2_LnuTwu',i_trial))
        recalls_U_forMixt_df.to_csv(summary_folder+r'{0}_ltr_recalls_U_{1}.csv'.format('2_LnuTwu',i_trial))
        ...
        precs_k_forMixt_df.to_csv(summary_folder+r'{0}_ltr_precs_k_{1}.csv'.format('2_LnuTwu',i_trial))
        precs_U_forMixt_df.to_csv(summary_folder+r'{0}_ltr_precs_U_{1}.csv'.format('2_LnuTwu',i_trial))