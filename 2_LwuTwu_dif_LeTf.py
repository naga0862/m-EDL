...
import pandas
summary_folder = r'Z:/ENN_acc/2_LwuTwu_ltr/'
# import requests
# import urllib3
...
if __name__ == '__main__':
    ...
    for i_trial in range (0,100):#take mean of result
        print('2_LwuTwu_ltr {}th trial!!!!!!!!!!!!!'.format(i_trial+1))
        ...
        accs_k_forMixlt_df.to_csv(summary_folder+r'{0}_ltr_accs_k_{1}.csv'.format('2_LwuTwu',i_trial))#index=mix_rate_t, column = mix_rate_learn
        accs_U_forMixlt_df.to_csv(summary_folder+r'{0}_ltr_accs_U_{1}.csv'.format('2_LwuTwu',i_trial))
        recalls_k_forMixlt_df.to_csv(summary_folder+r'{0}_ltr_recalls_k_{1}.csv'.format('2_LwuTwu',i_trial))#index=mix_rate_t, column = mix_rate_learn
        recalls_U_forMixlt_df.to_csv(summary_folder+r'{0}_ltr_recalls_U_{1}.csv'.format('2_LwuTwu',i_trial))
        precs_k_forMixlt_df.to_csv(summary_folder+r'{0}_ltr_precs_k_{1}.csv'.format('2_LwuTwu',i_trial))#index=mix_rate_t, column = mix_rate_learn
        precs_U_forMixlt_df.to_csv(summary_folder+r'{0}_ltr_precs_U_{1}.csv'.format('2_LwuTwu',i_trial))