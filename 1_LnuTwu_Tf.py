...
summary_folder = r'Z:/ENN_acc/1_LnuTwu/'
...
if __name__ == '__main__':
    ...
    for i_trial in range (0,100):#take mean of result
        print('1_LnuTwu {}th trial!!!!!!!!!!!!!'.format(i_trial+1))
        #"preparation of data"
        #mnist data
        ...
        #because it's condition 1, one-hot vector is 0 for em data
        ...
        x_test_em, y_test_em = preprocess_images(x_test_em, y_test_em)#because it's condition 1, one-hot vector is 0 for em data
        ...
        accs_k_forMixt_df.to_csv(summary_folder+r'{0}_accs_k_{1}.csv'.format('1_LnuTwu',i_trial))#index is mix rate for test data, column is unc_th
        accs_U_forMixt_df.to_csv(summary_folder+r'{0}_accs_U_{1}.csv'.format('1_LnuTwu',i_trial))
        ...
        recalls_k_forMixt_df.to_csv(summary_folder+r'{0}_recalls_k_{1}.csv'.format('1_LnuTwu',i_trial))#index is mix rate for test data, column is unc_th
        recalls_U_forMixt_df.to_csv(summary_folder+r'{0}_recalls_U_{1}.csv'.format('1_LnuTwu',i_trial))
        ...
        precs_k_forMixt_df.to_csv(summary_folder+r'{0}_precs_k_{1}.csv'.format('1_LnuTwu',i_trial))#index is mix rate for test data, column is unc_th
        precs_U_forMixt_df.to_csv(summary_folder+r'{0}_precs_U_{1}.csv'.format('1_LnuTwu',i_trial))
